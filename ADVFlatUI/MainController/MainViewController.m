...
- (void)viewDidLoad
{
    ...
    ControllerInfo* profile3 = [[ControllerInfo alloc] initWithName:@"Your Profile 3" andControllerId:@"ProfileController3"];
    ...
    self.storyboards = @[profileStoryboard, feedStoryboard ,settingsStoryboard, sidebarStoryboard];
